package APB_MASTER_env_pkg;
import uvm_pkg::*;
import APB_MASTER_agent_pkg::*;
import APB_MASTER_scoreboard_pkg::*;
import APB_MASTER_subscriber_pkg::*;
...
class APB_MASTER_env extends uvm_env;
    ...
    function void build_phase(uvm_phase phase);
        ...
        ag = APB_MASTER_agent::type_id::create("ag", this);
        sc = APB_MASTER_scoreboard::type_id::create("sc", this);
